...
```
[2026-02-01 04:44:17.752] INFO - Starting Bamboo Server on port 8080
...
# Debug 模式
DEBUG=true ./target/release/bamboo-server \
  --llm-base-url http://localhost:12123 \
  --model kimi-for-coding
```
...
```bash
./target/release/bamboo-cli send "你好"
./target/release/bamboo-cli stream "讲个笑话"
```
