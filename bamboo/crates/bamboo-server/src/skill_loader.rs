...
use bamboo_core::tools::{ToolSchema, FunctionSchema};
use bamboo_builtin_tools::normalize_tool_ref;
...
impl SkillLoader {
    /// Create new skill loader with default directory (~/.bamboo/skills)
    pub fn new() -> Self {
