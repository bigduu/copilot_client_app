...
import { AgentInputPanel, QueuedPrompt } from "./AgentInputPanel";
...
export const AgentView: React.FC = () => {
  ...
  const handleOpenProject = useCallback(async () => {
    ...
    try {
      ...
      setProjectsError(e instanceof Error ? e.message : "Failed to open project");
    }
  }, [loadProjectsIndex]);
  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        const data = await claudeCodeService.listProjectSessions(
          selectedProjectId,
        );
        setSessions(data);
      } catch (e) {
  ...
  }, [selectedProjectId, sessionsRefreshNonce]);
