...
use bytes::Bytes;
use context_manager::{
    ChatContext, ChatEvent, ContextUpdate, IncomingMessage, IncomingTextMessage, MessageMetadata,
    MessageTextSnapshot, MessageType, Role, ToolCallRequest, ToolCallResult,
};
            ...
            Ok(response) => {
                ...
                if let Some(message_id) = assistant_message_id {
                    let final_text = {
                        ...
                        ctx.handle_event(ChatEvent::LLMResponseProcessed {
