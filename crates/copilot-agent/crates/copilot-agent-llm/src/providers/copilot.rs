    ...
    fn convert_messages(&self, messages: &[Message]) -> Vec<serde_json::Value> {
        messages.iter().map(|m| {
            let role = match m.role {
                copilot_agent_core::agent::Role::System => "system",
                copilot_agent_core::agent::Role::User => "user",
                copilot_agent_core::agent::Role::Assistant => "assistant",
                copilot_agent_core::agent::Role::Tool => "tool",
            };
...
mod tests {
    ...
    fn test_convert_messages() {
        let provider = CopilotProvider::new();
        let messages = vec![
            copilot_agent_core::Message::system("You are helpful"),
            copilot_agent_core::Message::user("Hello"),
        ];
