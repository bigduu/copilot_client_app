...
use crate::extension_system::types::{Tool, Category, CategoryInfo, ToolConfig};
use crate::extension_system::registry::GlobalRegistry;
...
impl ToolsManager {
    ...
    pub async fn execute_tool(&self, tool_name: &str, parameters: Vec<crate::extension_system::types::Parameter>) -> anyhow::Result<String> {
