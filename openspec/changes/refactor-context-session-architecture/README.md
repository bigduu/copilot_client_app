...
1. **[DEPRECATIONS.md](../../DEPRECATIONS.md)**
   - 废弃 API 清单
   - 迁移时间表
   - 替代方案

2. **[STREAM_API_MIGRATION.md](../../STREAM_API_MIGRATION.md)**
   - 流式 API 对比
   - 未来升级路径
   - 代码示例
...
详见 [STREAM_API_MIGRATION.md](../../STREAM_API_MIGRATION.md)
